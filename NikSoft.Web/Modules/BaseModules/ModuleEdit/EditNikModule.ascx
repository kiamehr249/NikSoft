<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EditNikModule.ascx.cs" Inherits="NikSoft.Web.Modules.BaseModules.ModuleEdit.EditNikModule" %>
...
<div class="row">
	<div class="col-md-12 text-center">
		<a href='<%= ResolveUrl("~/panel/ShowEditableModules/" + ModuleParameters) %>' class="btn btn-default btn-back">بازگشت</a>
