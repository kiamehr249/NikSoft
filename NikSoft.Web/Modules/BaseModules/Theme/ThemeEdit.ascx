<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ThemeEdit.ascx.cs" Inherits="NikSoft.Web.Modules.BaseModules.Theme.ThemeEdit" %>
...
<div class="row" runat="server" id="err_msgs">
	<div class="col-md-12">
        <div class="alert alert-danger">
            <h3>Something wrog to save file</h3>
            <p>Problems is:</p>
            <ul>
                <asp:Literal ID="lNums" runat="server"></asp:Literal>
            </ul>
        </div>
	</div>
</div>
...
<div class="row">
	<div class="col-md-12 text-center">
		...
		<a href='<%= ResolveUrl("~/panel/ThemeCreator/" + ModuleParameters) %>' class="btn btn-default btn-back-nik">بازگشت</a>
	</div>
</div>
<script>
