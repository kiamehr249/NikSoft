<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="rd_UserTypeGroup.ascx.cs" Inherits="NikSoft.Web.Modules.BaseModules.User.rd_UserTypeGroup" %>
...
<div class="row">
    <div class="col-md-12 table-responsive">
        <Nik:NikGridView ID="GV1" runat="server" ItemType="NikSoft.NikModel.UserTypeGroup">
            <EmptyDataTemplate>
