<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Login.ascx.cs" Inherits="NikSoft.Web.Modules.BaseModules.User.Login" %>
    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            ...
            <div class="callout callout-danger" id="msg" runat="server" visible="false">
                <h4><asp:Label runat="server">نام کاربری یا رمز عبور اشتباه می باشد.</asp:Label></h4>   
            </div>
        </div>
    </div>
</div>