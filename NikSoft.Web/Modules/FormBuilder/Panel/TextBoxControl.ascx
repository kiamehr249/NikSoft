<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TextBoxControl.ascx.cs" Inherits="NikSoft.FormBuilder.Web.Panel.TextBoxControl" %>
<style>
    .out {
        display: none;
    }
...
<div class="row">
    <div class="col-sm-3 text-box out">
        <div class="form-group">
    ...
    <div class="col-sm-3 text-area out">
        <div class="form-group">
