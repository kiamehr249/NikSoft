<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FormTemplate.ascx.cs" Inherits="NikSoft.FormBuilder.Web.Panel.FormTemplate" %>
...
<div class="row">
	<div class="col-md-12 text-center">
		...
		<a href='<%= ResolveUrl("~/" + Level + "/rd_Forms") %>' class="btn btn-default btn-back-nik">بازگشت</a>
	</div>
</div>
