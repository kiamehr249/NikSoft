<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AddItemToListControl.ascx.cs" Inherits="NikSoft.FormBuilder.Web.Panel.AddItemToListControl" %>
...
<div class="row">
    ...
    <div class="col-sm-3">
        <div class="form-group">
            ...
            <asp:DropDownList ID="ddlParents" runat="server" CssClass="form-control select2" ClientIDMode="Static">
            </asp:DropDownList>
        </div>
    </div>
</div>
            ...
            <Nik:NikGridView ID="GV1" PageSize="15" runat="server" ItemType="NikSoft.FormBuilder.Service.ListControlItemModel" OnRowCommand="GV1_RowCommand">
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="نوع">
                        <ItemTemplate>
                            <%# GetControlType(Item.ListControl.ControlType) %>
                        </ItemTemplate>
                    </asp:TemplateField>
