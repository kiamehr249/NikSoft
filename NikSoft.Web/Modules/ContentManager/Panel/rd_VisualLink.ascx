<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="rd_VisualLink.ascx.cs" Inherits="NikSoft.ContentManager.Web.Panel.rd_VisualLink" %>
...
<div class="row">
    <div class="col-md-12 table-responsive">
        <Nik:NikGridView ID="GV1" PageSize="15" runat="server" ItemType="NikSoft.ContentManager.Service.VisualLink" OnRowCommand="GV1_RowCommand">
            <EmptyDataTemplate>
                    ...
                    <ItemTemplate>
                        <div class="form-group text-center">
                            <div class="btn-group-vertical">
                                <asp:HyperLink ID="hpFiles" runat="server" NavigateUrl='<%# "/panel/rd_VisualLinkItem/" + Item.ID %>' CssClass="btn btn-edite btn-sm">آیتم ها</asp:HyperLink>
                            </div>
                        </div>
                    </ItemTemplate>
                </asp:TemplateField>
