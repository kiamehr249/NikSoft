<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="rd_GeneralMenuItem.ascx.cs" Inherits="NikSoft.ContentManager.Web.Panel.rd_GeneralMenuItem" %>
...
<div class="row">
    <div class="col-md-12 table-responsive">
        <Nik:NikGridView ID="GV1" PageSize="15" runat="server" ItemType="NikSoft.ContentManager.Service.GeneralMenuItem" OnRowCommand="GV1_RowCommand">
            <EmptyDataTemplate>
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="‌تنظیمات">
                    <ItemTemplate>
                        <a href="<%# GetLink(Item.ID) %>" class="btn btn-edite btn-sm">آیتم‌ها</a>
                    </ItemTemplate>
                </asp:TemplateField>
