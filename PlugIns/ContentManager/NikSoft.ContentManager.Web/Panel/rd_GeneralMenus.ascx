<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="rd_GeneralMenus.ascx.cs" Inherits="NikSoft.ContentManager.Web.Panel.rd_GeneralMenus" %>
...
<div class="row">
    <div class="col-md-12 table-responsive">
        <Nik:NikGridView ID="GV1" PageSize="15" runat="server" ItemType="NikSoft.ContentManager.Service.GeneralMenu" OnRowCommand="GV1_RowCommand">
            <EmptyDataTemplate>
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="‌تنظیمات">
                    <ItemTemplate>
                        <a href="<%# "/panel/rd_GeneralMenuItem/default?MainID=" + Item.ID %>" class="btn btn-edite btn-sm">آیتم‌ها</a>
                    </ItemTemplate>
                </asp:TemplateField>
