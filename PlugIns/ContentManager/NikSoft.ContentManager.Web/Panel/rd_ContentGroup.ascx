<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="rd_ContentGroup.ascx.cs" Inherits="NikSoft.ContentManager.Web.Panel.rd_ContentGroup" %>
...
<div class="row">
    <div class="col-md-12 table-responsive">
        <Nik:NikGridView ID="GV1" PageSize="15" runat="server" ItemType="NikSoft.ContentManager.Service.ContentGroup" OnRowCommand="GV1_RowCommand">
            <EmptyDataTemplate>
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="جزئیات">
                    <ItemTemplate>
                        <p>ساخته شده توسط: <%# Item.CreatedBy != null ? GetName(Item.CreatedBy.Value) : "-" %></p>
                        <p>تاریخ ساخت: <%# Item.CreateDateTime %></p>
                    </ItemTemplate>
                </asp:TemplateField>
