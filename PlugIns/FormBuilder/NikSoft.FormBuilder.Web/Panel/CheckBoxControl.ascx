<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CheckBoxControl.ascx.cs" Inherits="NikSoft.FormBuilder.Web.Panel.CheckBoxControl" %>
...
<div class="row">
    ...
    <div class="col-md-3">
        <div class="checkbox">
            ...
            <label>
                <asp:CheckBox ID="chbIsChecked" runat="server" ClientIDMode="Static" />
                پیش فرض انتخاب شده باشد؟
            </label>
        </div>
    </div>
</div>
...
<div class="text-box-list">
    ...
    <div class="row">
        <div class="col-md-12 table-responsive">
            <Nik:NikGridView ID="GV1" PageSize="15" runat="server" ItemType="NikSoft.FormBuilder.Service.CheckBoxModel" OnRowCommand="GV1_RowCommand">
                <EmptyDataTemplate>
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="پیش فرض">
                        <ItemTemplate>
                            <div class="text-center">
                                <%# Item.Checked ? "پر" : "خالی" %>
                            </div>
                        </ItemTemplate>
                    </asp:TemplateField>
